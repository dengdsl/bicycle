...
CREATE TABLE `bicycle_info`  (
  ...
  `qrcode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '二维码编码',
...
-- ----------------------------
INSERT INTO `bicycle_info` VALUES ('BY20250208279369', '1', 'http://www.server.lunwheels.com/static/images/2025/02/08/1739056612banner1.jpg;http://www.server.lunwheels.com/static/images/2025/02/08/1739068001banner2.jpg', '123456789456123', '2025-02-07 16:00:00', 'AX48GEOQ3ODV7EWA78I3V20MIGMPQHJP', '/static/qrcode/2025/02/08/AX48GEOQ3ODV7EWA78I3V20MIGMPQHJP.png', 1, '测试数据', 0, '2025-02-08 15:04:31', '2025-02-08 15:04:31', NULL);
...
-- ----------------------------
INSERT INTO `sys_config` VALUES (1, 2, 'sys', 'filings', '网站IC备案链接', 'https://www.server.lunwheels.com', '网站备案链接', '2024-01-10 22:44:41', '2025-02-08 23:06:56');
INSERT INTO `sys_config` VALUES (2, 5, 'sys', 'webLogo', '登录页LOGO', 'http://www.server.lunwheels.com/static/config/2025/02/08/1739086782logo.png', '登录界面LOGO，建议宽高比例为320:43', '2024-01-10 22:44:41', '2025-02-08 22:56:56');
INSERT INTO `sys_config` VALUES (3, 1, 'sys', 'webName', '登录页系统名称', '银斯贝自行车管理系统', '网站名称', '2024-01-10 22:44:41', '2025-01-17 22:49:45');
INSERT INTO `sys_config` VALUES (4, 6, 'sys', 'webFavicon', '网站LOGO', 'http://www.server.lunwheels.com/static/config/2025/02/08/1739095040favicon.png', '网站logo', '2024-01-10 22:44:41', '2025-02-08 22:11:26');
...
INSERT INTO `sys_config` VALUES (8, 2, 'banner', 'bannerImgs', '公众号查询界面图片', '[{\"src\":\"http://www.server.lunwheels.com/static/config/2025/02/08/1739059241banner1.jpg\",\"sort\":1},{\"src\":\"http://www.server.lunwheels.com/static/config/2025/02/08/1739041442banner2.jpg\",\"sort\":2}]', '轮播图列表，列表项中必须包含src属性，建议图片宽高比为4：3', '2025-01-15 23:27:44', '2025-02-08 22:50:15');
INSERT INTO `sys_config` VALUES (9, 4, 'sys', 'loginBg', '管理后台登录背景图', 'http://www.server.lunwheels.com/static/config/2025/02/08/17390690491737405237loginbg.png', '登录界面背景图', '2025-01-15 23:30:10', '2025-02-08 23:00:36');
...
INSERT INTO `sys_config` VALUES (17, 1, 'sys', 'loginFooterBg', '页脚背景图', 'http://www.server.lunwheels.com/static/config/2025/02/08/17391146401737398251winspace.png', '登录界面底部背景图片，宽高比例建议为1920:200', '2025-01-20 14:38:36', '2025-02-08 23:00:36');
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (1, NULL, '银斯贝', 0, '超级管理员', '18888888888', 0, '2025-01-09 14:22:34', '2025-01-09 14:22:34');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户部门关联表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `sys_dict_data` VALUES (1, 'model', '公路自行车', 1, 1, '', 0);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '123456', 'http://www.server.lunwheels.com/static/avatar/2025/02/08/1739099108favicon.png', '2564888970@qq.com', 'admin', 0, '超级管理员', '2024-02-29 20:38:34', '2025-02-08 14:49:52');
-- ----------------------------
