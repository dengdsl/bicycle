          ...
          <el-table :data="pager.lists" size="large" v-loading="pager.loading">
            ...
            <el-table-column label="状态" min-width="100">
              <template #default="{ row }">
                <el-tag v-if="row.roleState === 0">正常</el-tag>
                <el-tag type="danger" v-if="row.roleState === 1">禁用</el-tag>
              </template>
            </el-table-column>
...
import { roleLists, roleDelete } from '@/api/permission/role'
